...
```{r}
data_path = 'PATH_TO/'
recall_events = read_csv(paste0(data_path,'recall_events.csv'))
narrative_recall = read_csv(paste0(data_path,'recall_narrative.csv'))
isc_data = read_csv(paste0(data_path,'event_isc_results.csv'))
```
